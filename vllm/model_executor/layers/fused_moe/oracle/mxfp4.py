...
def convert_weight_to_mxfp4_moe_kernel_format(
    ...
    if mxfp4_backend in TRTLLM_BACKENDS:
        ...
        # Checkpoints store gate/up as [w1; w3], while FlashInfer consumes
        # [w3; w1]. Keep weights, scales, and bias in the same order.
        ...
        raise ValueError(
            ...
            "Expected TRTLLM, FlashInfer CUTLASS, Triton, AITER, or XPU backend."
        )
